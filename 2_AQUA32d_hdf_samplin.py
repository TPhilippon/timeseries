...
xzrmin,xzrmax,yzrmin,yzrmax=1250,1750,750,1100      # ZR pour 9 km
...
ezi[0:nzi]=([(1430,1433,882,888),(1433,1437,901,907),(1410,1412,861,864),(1710,1717,897,902)])  # Coordonnées des ZI 9km
#ezi[0:nzi]=([(2860,2866,1764,1777),(2867,2874,1802,1814),(2820,2825,1722,1728),(3420,3434,1795,1805)])  # Coordonnées des ZI 4km
#ezi[0:nzi]=([(2858,2804,1764,1776),(2870,2876,1804,1814),(2816,2820,1720,1726),(3430,3436,1800,1806)])  # Coordonnées des ZI
# ----------------------------------------------------------------

varnum = 3
#variable = ['nsst_8d', 'poc_8d', 'sst11mic_8d', 'chl_8d'][varnum]      # 8D
variable = ['nsst_32d', 'poc_32d', 'sst11mic_32d', 'chl_32d'][varnum]   # 32D
...
#for varnum in [0,1,2,3]:       # Si les 4 variables sont DL
varnum = 3                      # Si une seule variable

    
slope=slI[varnum][0]                                              #  égal au premier de la paire
intercept=slI[varnum][1] 
pathZR ='/home/pressions/SATELITIME/data/ZR/swf/'+str(variable)+'/9km/'
pathZI ='/home/pressions/SATELITIME/data/ZI/swf/'+str(variable)+'/9km/'                       #  Unix
data_in ='/home/pressions/SATELITIME/data/FULL/'+str(variable)+'/swf/9km/'
