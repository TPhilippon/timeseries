...
xzrmin,xzrmax,yzrmin,yzrmax=00,1000,500,3000
ezr=[xzrmin,xzrmax,yzrmin,yzrmax]
...
#dzr = np.dot(dzr,1.0)
zr=dzr[xzrmin:xzrmax,yzrmin:yzrmax]
plt.imshow(zr,norm=norm, cmap=new_map,interpolation='none',aspect='equal',origin='upper')
#plt.axis([00,1000,500,3000])
