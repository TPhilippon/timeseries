...
ezi[0:nzi]=([(2862,2868,1766,1774),(2870,2874,1810,1814),(2858,2862,1741,1745),(3430,3434,1800,1805)])
...
pathZR ='/home/pressions/SATELITIME/data/ZR/' 
pathZI ='/home/pressions/SATELITIME/data/ZI/'  #Unix
data_in ='/home/pressions/SATELITIME/data/'+str(variable)+'/hdf/'
...
plt.show()
    #------------ zone d'intérêt
for nzi in range(0,ezi.size):
    print "ZI numero :",nzi
    xzimin,xzimax,yzimin,yzimax=ezi[nzi][0],ezi[nzi][1],ezi[nzi][2],ezi[nzi][3]
...
for myfile in files:
    ...
    filezi = pathZI+myfile[0:38]+'_ZIs'
    filezr = pathZR+myfile[0:38]+'_ZR'
    np.save(filezr,data)
